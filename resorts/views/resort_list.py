...
def get_resort_list(selected_resorts, user_address = "", number_to_display = NUMBER_TO_DISPLAY, order_on = DEFAULT_ORDER_ON):
    """ Given a list of selected resorts, returns an ordered list of resorts and their conditions for display.
...
def use_googlemaps(address, selected_resorts, resorts_list):
    ...
    Args:
        address (str): Indicates the user address
        resorts_list (list): Queryset of Resorts
